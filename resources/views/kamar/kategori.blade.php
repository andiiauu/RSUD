        ...
        <div class="col-md-12">
          <div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">Data Kategorikamar</h3>
          <div class="right">
            <button type="button" class="lnr lnr-plus-circle" data-toggle="modal" data-target="#exampleModal">
              ...
              <tr>
                ...
                <th class="text-center">Action</th>
						...
						<tbody>
              @foreach ($kategorikamar as $key => $katkamar)
                <tr>
                  <th class="text-center">{{++$key}}</th>
                  <th class="text-center">{{$katkamar->nama_kamar}}</th>
                  <th class="text-center">{{$katkamar->harga_kamar}}</th>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content modal-media-content">
      ...
      <div class="modal-body pt0 pb0">
        <form action="/kategorikamar/create" method="post">
          {{csrf_field()}}
              <div class="row">
                                  ...
                                  <div class="row ptt10">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input name="nama_kamar" placeholder="" type="text" class="form-control"  value="" />
                                      ...
                                      <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Harga</label>
                                                <input type="number" name="harga_kamar" value="" class="form-control">
                                            </div>
                                        </div>
...
<div class="modal modal-danger fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampdeletepasien" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form action="{{route('kategorikamar.destroy', $katkamar->id)}}" method="post">
              {{method_field('delete')}}
              {{csrf_field()}}
